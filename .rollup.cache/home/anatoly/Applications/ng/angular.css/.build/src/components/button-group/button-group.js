const separatorSelector = '[data-slot="button-group-separator"], [ng-button-group-separator]';
...
export function buttonGroupDirective() {
    return {
        link(_scope, element) {
            ...
            element
                .querySelectorAll(separatorSelector)
                .forEach((separator) => {
