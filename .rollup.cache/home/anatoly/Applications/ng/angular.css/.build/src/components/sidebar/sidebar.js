    ...
    return {
        link(scope, element) {
            ...
            const syncResponsive = () => {
                setAttributeIfChanged(element, "data-mobile", String(mobileQuery.matches));
            };
            ...
            const syncOptions = () => {
                const reflect = (name, fallback) => {
                    ...
                    setAttributeIfChanged(element, `data-${name}`, authored && sidebarOptions[name].has(authored)
                        ? authored
                        : fallback);
                };
            ...
            const setCollapsed = (collapsed) => {
                ...
                cleanupTriggers.forEach((_, trigger) => {
                    ...
                    setAttributeIfChanged(trigger, "data-state", collapsed ? "closed" : "open");
                });
            ...
            const bindTrigger = (trigger) => {
                ...
                setAttributeIfChanged(trigger, "data-state", getCollapsed() ? "closed" : "open");
