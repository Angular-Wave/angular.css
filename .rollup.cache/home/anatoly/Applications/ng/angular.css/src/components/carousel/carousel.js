    ...
    return {
        link(scope, element) {
            ...
            const syncStaticSemantics = () => {
                ...
                const dots = getDots();
                setAttributeIfChanged(element, "role", element.getAttribute("role") ?? "region");
                ...
                items.forEach((item, index) => {
                    setAttributeIfChanged(item, "role", item.getAttribute("role") ?? "group");
            ...
            const syncSelectedState = () => {
                ...
                setAttributeIfChanged(element, "data-can-scroll-previous", String(api.canScrollPrev()));
                setAttributeIfChanged(element, "data-can-scroll-next", String(api.canScrollNext()));
                getItems().forEach((item, index) => {
                    setAttributeIfChanged(item, "data-active", String(index === detail.itemIndex));
