...
This is a styling-only HTML element or pattern. AngularCSS registers no runtime directive for it. A spinner is styled status content with authored accessibility semantics.
