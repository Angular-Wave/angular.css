...
This is a styling-only HTML element or pattern. AngularCSS registers no runtime directive for it. A badge is a styled inline HTML pattern with authored variants.
