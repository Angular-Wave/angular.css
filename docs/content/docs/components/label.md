...
This is a styling-only HTML element or pattern. AngularCSS registers no runtime directive for it. Native label association and form state provide the complete contract.
