...
{{< example src="examples/components/sonner.html" title="Sonner example" height="250" >}}
...
{{< example src="examples/components/sonner-workflows.html" title="Sonner reference workflows" height="1200" >}}
...
This component's root directive is `[ng-toaster]`. Importing the package registers it with the AngularCSS `ui` module; there is no per-component JavaScript registration step.
