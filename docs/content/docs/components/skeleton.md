...
This is a styling-only HTML element or pattern. AngularCSS registers no runtime directive for it. A skeleton is a styled placeholder with authored accessibility semantics.
