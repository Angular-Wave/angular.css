...
This component's root directive is `[ng-tooltip]`. Importing the package registers it with the AngularCSS `ui` module; there is no per-component JavaScript registration step.
